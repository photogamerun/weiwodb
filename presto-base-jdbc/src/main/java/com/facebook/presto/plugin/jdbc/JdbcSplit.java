...
public class JdbcSplit implements ConnectorSplit {
	...
	private final PushDown pushdown;
	...
	public JdbcSplit(@JsonProperty("connectorId") String connectorId,
			...
			@JsonProperty("predicates") PushDown pushdown) {
		this.connectorId = requireNonNull(connectorId, "connector id is null");
		this.catalogName = catalogName;
		this.schemaName = schemaName;
		this.tableName = requireNonNull(tableName, "table name is null");
		this.connectionUrl = requireNonNull(connectionUrl,
				"connectionUrl is null");
		this.connectionProperties = ImmutableMap.copyOf(requireNonNull(
				connectionProperties, "connectionProperties is null"));
		this.tupleDomain = requireNonNull(tupleDomain, "tupleDomain is null");
		this.pushdown = requireNonNull(pushdown, "predicate is null");
	}

	@JsonProperty
	public PushDown getPredicates() {
		return pushdown;
	}
