...
public class NodeSchedulerConfig
{
    ...
    private boolean includeWeiwoManager = true;
    ...
    public boolean isIncludeWeiwoManager()
    {
        return includeWeiwoManager;
    }

    @Config("node-scheduler.include-weiwomanager")
    public NodeSchedulerConfig setIncludeWeiwoManager(boolean includeWeiwoManager)
    {
