        ...
        implements NodeSelector
{
    ...
    private final boolean includeIndexmanager;
            ...
            int maxPendingSplitsPerNodePerStageWhenFull)
    {
        ...
        this.includeIndexmanager = includeIndexmanager;
    ...
    {
        return selectNodes(limit, randomizedNodes(nodeMap.get().get(), includeCoordinator, includeIndexmanager), doubleScheduling);
    }
    ...
    public Multimap<Node, Split> computeAssignments(Set<Split> splits, List<RemoteTask> existingTasks)
    {
        ...
        ResettableRandomizedIterator<Node> randomCandidates = randomizedNodes(nodeMap, includeCoordinator, includeIndexmanager);
        for (Split split : splits) {
            randomCandidates.reset();

            List<Node> candidateNodes;
            if (!split.isRemotelyAccessible()) {
                candidateNodes = selectExactNodes(nodeMap, split.getAddresses(), includeCoordinator, includeIndexmanager);
            }
            else {
