...
public class NodeMap
{
    ...
    private final Set<String> indexmanagerNodeIds;
    ...
    public NodeMap(SetMultimap<HostAddress, Node> nodesByHostAndPort,
            ...
            Set<String> indexmanagerNodeIds)
    {
        ...
        this.indexmanagerNodeIds = indexmanagerNodeIds;
    }
    ...
    public Set<String> getIndexmanagerNodeIds()
    {
        return indexmanagerNodeIds;
    }
}
