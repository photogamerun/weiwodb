...
public class IndexObserver implements Observer {
    ...
    public IndexObserver(LuceneIndexManager indexManager, IndexInfo indexInfo, WeiwoDBNodeInfo nodeInfo) {
    ...
    public void update(Observable o, Object arg) {
        indexManager.close(new IndexInfoWithNodeInfo(indexInfo, Arrays.asList(new WeiwoDBNodeInfo[] { nodeInfo })));
    }
    ...
    public boolean equals(Object obj) {
        ...
        final IndexObserver other = (IndexObserver) obj;
