 ...
 * @author peter.wei
 * 
 *         skip the type check in presto
 * 
 */
public class RealType extends AbstractIntType {
	...
	public int compareTo(Block leftBlock, int leftPosition, Block rightBlock,
			int rightPosition) {
		// WARNING: the correctness of InCodeGenerator is dependent on the
	...
	public void writeLong(BlockBuilder blockBuilder, long value) {
		try {
			...
			throw new PrestoException(GENERIC_INTERNAL_ERROR,
					format("Value (%sb) is not a valid single-precision float",
