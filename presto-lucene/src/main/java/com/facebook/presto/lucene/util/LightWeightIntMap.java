...
public class LightWeightIntMap<V> {
    ...
    transient volatile LightWeightIntMap<V>.Values values = null;
     ...
     */
    public LightWeightIntMap(int initialCapacity, float loadFactor) {
     ...
     * @throws IllegalArgumentException if the initial capacity is negative.
     */
    public LightWeightIntMap(int initialCapacity) {
     ...
     */
    public LightWeightIntMap(LightWeightIntMap<? extends V> m) {
    ...
    private void putAllForCreate(LightWeightIntMap<? extends V> m) {
        LightWeightIntMap<? extends V>.EntrySet s = m.entrySet();
        LightWeightIntMap<? extends V>.EntryIterator it = s.iterator();
        while(it.hasNext()){
            Entry<? extends V> v = it.next;
            putForCreate(v.getKey(), v.getValue());
        }
    }
     ...
     * @throws NullPointerException if the specified map is null
     */
    public void putAll(LightWeightIntMap<? extends V> m) {
     ...
     */
    public Object clone() {
        LightWeightIntMap<V> result = null;
        try {
            result = (LightWeightIntMap<V>)super.clone();
    ...
    static class Entry<V> {
         ...
         * in the HashMap.
         */
        void recordAccess(LightWeightIntMap<V> m) {
        }
         ...
         */
        void recordRemoval(LightWeightIntMap<V> m) {
        }
    }
    ...
    private abstract class HashIterator {
        ...
        public void remove() {
            ...
            int k = current.key;
            current = null;
            LightWeightIntMap.this.removeEntryForKey(k);
            expectedModCount = modCount;
        }
    }
    ...
    public final class KeySet {
        ...
        public boolean remove(int o) {
            return LightWeightIntMap.this.removeEntryForKey(o) != null;
        }
        public void clear() {
            LightWeightIntMap.this.clear();
        }
    }
