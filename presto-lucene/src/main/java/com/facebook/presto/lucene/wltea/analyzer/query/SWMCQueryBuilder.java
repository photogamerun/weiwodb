 ...
 *
 */
package com.facebook.presto.lucene.wltea.analyzer.query;
...
import com.facebook.presto.lucene.wltea.analyzer.core.IKSegmenter;
import com.facebook.presto.lucene.wltea.analyzer.core.Lexeme;
...
public class SWMCQueryBuilder {
    ...
    public static Logger logger = Logger.get(SWMCQueryBuilder.class);;
