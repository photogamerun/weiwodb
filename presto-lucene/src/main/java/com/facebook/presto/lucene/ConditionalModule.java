...
public final class ConditionalModule<T> extends AbstractConfigurationAwareModule {
	public static <T> ConfigurationAwareModule conditionalModule(
			Class<T> config, Predicate<T> predicate, Module module) {
	...
	private ConditionalModule(Class<T> config, Predicate<T> predicate,
			Module module) {
		this.config = config;
