...
public class LightWeightLongSet {
     ...
     */
    public LightWeightLongSet(int initialCapacity, float loadFactor) {
     ...
     * @throws IllegalArgumentException if the initial capacity is negative.
     */
    public LightWeightLongSet(int initialCapacity) {
     ...
     */
    public LightWeightLongSet(LightWeightLongSet m) {
    ...
    static int indexFor(long key, int length) {
    ...
    private void addForCreate(long key) {
        int i = indexFor(key, table.length);
        for (Entry e = table[i]; e != null; e = e.next) {
            long k;
            if ((k = e.key) == key || (key == k)) {
    ...
    private void addAllForCreate(LightWeightLongSet m) {
        LightWeightLongSet.KeySet s = m.keySet();
     ...
     * @throws NullPointerException if the specified map is null
     */
    public void addAll(LightWeightLongSet m) {
    ...
    public Object clone() {
        LightWeightLongSet result = null;
        try {
            result = (LightWeightLongSet)super.clone();
    ...
    static class Entry {
         ...
         * in the HashMap.
         */
        void recordAccess(LightWeightLongSet m) {
        }
         ...
         */
        void recordRemoval(LightWeightLongSet m) {
        }
    }
    ...
    private abstract class HashIterator {
        ...
        public void remove() {
            ...
            long k = current.key;
            current = null;
            LightWeightLongSet.this.removeEntryForKey(k);
            expectedModCount = modCount;
        }
    }
    ...
    public final class KeySet {
        ...
        public boolean remove(int o) {
            return LightWeightLongSet.this.removeEntryForKey(o) != null;
        }
        public void clear() {
            LightWeightLongSet.this.clear();
        }
    }
